...
<head>
	<meta charset="utf-8">
	<title>JsSIP Class: ConfigurationError</title>
...
<header>
    <h2>
        <span class="ancestors"><a href="JsSIP.html">JsSIP</a><a href="JsSIP.Exceptions.html">.Exceptions</a>.</span>
...
<dt>
    <h4 class="name" id="ConfigurationError"><span class="type-signature"></span>new ConfigurationError<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Exception thrown when a valid parameter is given to the JsSIP.UA constructor.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="Exceptions.js.html">Exceptions.js</a>,
				 <a href="Exceptions.js.html#sunlight-1-line-6">line 6</a>
			</li>
		</ul>
	</dd>
